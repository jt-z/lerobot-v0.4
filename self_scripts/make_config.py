...
用法：
    # 从基础配置创建新配置
    ./make_config.py configs/base.json --set dataset.repo_id=hellozjt/my_data --output configs/my_config.json

    # 从现有配置修改
    ./make_config.py configs/stable.json --set batch_size=8 --output configs/stable_small.json
...
示例:
  # 从基础配置创建新任务配置
  %(prog)s configs/base.json --set dataset.repo_id=hellozjt/my_task --set batch_size=16 -o configs/my_task.json

  # 修改现有配置
  %(prog)s configs/stable.json --set batch_size=8 -o configs/stable_small.json
